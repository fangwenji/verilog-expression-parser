...
def p_expression_mul(p):
    '''
    expression : term MUL term
    '''
    p[0] = ('mul', p[1], p[3])

def p_expression_div(p):
    '''
    expression : term DIV term
    '''
    p[0] = ('div', p[1], p[3])
...
# Parse an expression
expr_in = '(!(start||1\'b1)||c)'
expr_in = '(1\'b1&v)|(~u&(m|start)&t)'
ast = parser.parse(expr_in)
print('expr:\n', expr_in)
print('\nast:\n', ast)